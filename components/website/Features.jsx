            ...
            <div className="-m-8 flex flex-wrap sm:px-8">
                <div className="w-full p-8 md:w-1/2">
                    <div className="mx-auto sm:text-center"><Image alt="Image" loading="lazy" width="70" height="70" decoding="async" data-nimg="1" className="mb-7 sm:mx-auto" 
                        ...
                        <p className="text-lg font-medium tracking-tight">Curate AI leverages advanced machine learning models and the Solana blockchain to ensure fast, reliable, and creative content generation. Our AI understands your brand’s voice, audience preferences, and the latest trends to craft the perfect content every time.</p>
                    </div>
                </div>
                <div className="w-full p-8 md:w-1/2">
                    <div className="mx-auto sm:text-center"><Image alt="Image" loading="lazy" width="70" height="70" decoding="async" data-nimg="1" className="mb-7 sm:mx-auto"
                ...
                <div className="w-full p-8 md:w-1/2">
                    <div className="mx-auto sm:text-center"><Image alt="Image" loading="lazy" width="70" height="70" decoding="async" data-nimg="1" className="mb-7 sm:mx-auto"
                        ...
                        <p className="text-lg font-medium tracking-tight">Say goodbye to writer’s block and hours spent brainstorming content ideas. With Curate AI, you can generate high-quality, ready-to-post content in seconds, allowing you to focus on what really matters—growing your brand.</p>
                    </div>
                </div>
            </div>
        </div>
